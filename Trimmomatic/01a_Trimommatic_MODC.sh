...
-i /SAN/ugi/LepGenomics/C3_Aricia_agestis_FP/00_raw_reads_modern \
-o /SAN/ugi/LepGenomics/C3_Aricia_agestis_FP/01a_Trimmomatic_modc \
-N C3.Trimmomatic.Modc \
-n 1 -t 8 -m 15 -ph 33 -c 150 -hc 0 \
