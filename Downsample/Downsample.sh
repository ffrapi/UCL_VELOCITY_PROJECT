...
INPUT=$SHAREDFOLDER/$SPECIES/04_Downsampled_MODC
OUTPUT=$SHAREDFOLDER/$SPECIES/04_Downsampled_MODC



paste modc.names.100 modc.prop.downsample.39 modc.propnames.39 | while IFS=$'\t' read -r var1 var2 var3; do java -jar $PICA$
I=$INPUT/"$var1" \
